...
// import { Card, Typography, Descriptions, Table, Tag, Button, Popconfirm, Spin, Empty, Divider, Space } from 'antd';
...
//     const { id } = useParams();
//     const { batchDetail, loading, loadBatchDetail, handleCancelBatch } = useBatchDetail();

//     useEffect(() => {
//         loadBatchDetail(id);
//     }, [id]);

//     const canCancel = batchDetail && ['pending'].includes(batchDetail.status);
//     const canExtend = batchDetail && ['borrowed'].includes(batchDetail.status);
